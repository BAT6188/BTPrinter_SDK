...
import com.rmicro.printers.btprinter.api.PrintDataMaker;
import com.rmicro.printers.btprinter.api.PrintExecutor;
import com.rmicro.printers.btprinter.api.PrintSocketHolder;
import com.rmicro.printers.btprinter.api.PrinterWriter;
import com.rmicro.printers.btprinter.api.PrinterWriter58mm;
import com.rmicro.printers.btprinter.dialog.LoadingDialog;
    ...
    private void doPrint() {
        ...
        executor.doPrinterRequestAsync(new PrintDataMaker() {
            ...
            public List<byte[]> getPrintData(int type) {
                ...
                try {
                    PrinterWriter printer = new PrinterWriter58mm(10, 554);
