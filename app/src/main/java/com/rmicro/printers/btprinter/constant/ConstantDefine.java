package com.rmicro.printers.btprinter.constant;
...
public class ConstantDefine {
    ...
    public static final String ACTION_IMG_PRINT_TEST = "action_image_print";
    public static final String ACTION_GET_PRINT_STATUS = "action_get_print_status";
