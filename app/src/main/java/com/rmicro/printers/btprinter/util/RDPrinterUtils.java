...
public class RDPrinterUtils {
    ...
    public static RDPrinterUtils mInstance = null;

    public RDPrinterUtils() {
    }
    public static RDPrinterUtils getInstance() {
        if (mInstance == null) {
            mInstance = new RDPrinterUtils();
        }
        return mInstance;
    }
