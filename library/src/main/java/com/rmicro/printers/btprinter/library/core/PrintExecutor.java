...
package com.rmicro.printers.btprinter.library.core;
...
public class PrintExecutor {
     ...
     * @return 错误代码
     */
    private int doRequest(com.rmicro.printers.btprinter.library.core.PrintDataMaker maker) {
     ...
     * @return 错误代码
     */
    public int doPrinterRequest(com.rmicro.printers.btprinter.library.core.PrintDataMaker maker) {
     ...
     * 异步执行打印请求
     */
    public void doPrinterRequestAsync(com.rmicro.printers.btprinter.library.core.PrintDataMaker maker) {
    ...
    private class PrintTask extends AsyncTask<com.rmicro.printers.btprinter.library.core.PrintDataMaker, Integer, Integer> implements
        ...
        @Override
        protected Integer doInBackground(com.rmicro.printers.btprinter.library.core.PrintDataMaker... makers) {
